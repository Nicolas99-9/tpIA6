...
constraints{
    ...
    c["NordOuest"] >= c["NordEst"];    // symetrie verticale
    c["NordOuest"] >= c["SudOuest"];    // symetrie horizontale
    c["NordOuest"] >= c["SudEst"];    // symetrie diagonale /
    c["SudOuest"] >= c["NordEst"];    // symetrie diagonale \
